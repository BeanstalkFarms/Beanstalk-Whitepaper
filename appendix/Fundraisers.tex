...
Up to (2) assets pegged to \hyperlink{ht216}{$V$} can be exchanged for 1 \term{Sown} Bean's \term{Yield} of \term{Pods} each, based on the \term{Temperature} at the time of the contribution to the \term{Fundraiser}. Tokens raised via a \term{Fundraiser} are automatically distributed to (3) upon completion of the \term{Fundraiser}.
