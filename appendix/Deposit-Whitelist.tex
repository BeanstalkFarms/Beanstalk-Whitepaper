...
$$f^{\bean}(z^{\bean}) = z^{\bean}$$
        ...
        \item \textbf{Seeds per BDV:} \Bean\ \term{Deposits} receive 2 \term{Seeds} per BDV upon \term{Deposit} (\term{i.e.}, $c^{\bean} = 2$).
    \end{enumerate}
\subsubsection{$\Phi$}
    \begin{enumerate}
...
$$f^{\hyperlink{ht187}{\Phi}}(z^{\hyperlink{ht187}{\Phi}}) = \frac{z^{\hyperlink{ht187}{\Phi}} \times ( \hyperlink{ht193}{\Phi_{\Xi-1}^{\bean}} + f^{\text{3CRV}}(\hyperlink{ht194}{\Phi_{\Xi-1}^{\text{3CRV}}}))}{\hyperlink{ht192}{\Phi_{\Xi-1}}}$$
        \item \textbf{Stalk per BDV:} \hyperlink{ht187}{$\Phi$} \term{Deposits} receive 1 \term{Stalk} per BDV upon \term{Deposit} (\term{i.e.}, $k^{\hyperlink{ht187}{\Phi}} = 1$).
        \item \textbf{Seeds per BDV:} \hyperlink{ht187}{$\Phi$} \term{Deposits} receive 4 \term{Seeds} per BDV upon \term{Deposit} (\term{i.e.}, $c^{\hyperlink{ht187}{\Phi}} = 4$).
    \end{enumerate}
...
We define $f^{\mathfrak{z}^{\tinybean}}(z^{\mathfrak{z}^{\tinybean}})$ as:
        ...
        \item \textbf{Stalk per BDV:} \Bean\ \term{Deposits} receive 1 \term{Stalk} per BDV upon \term{Deposit} (\term{i.e.}, $k^{\hyperlink{ht233}{\mathfrak{z}^{\bean}}} = 1$).
        \item \textbf{Seeds per BDV:} \Bean\ \term{Deposits} receive 0 \term{Seeds} per BDV upon \term{Deposit} (\term{i.e.}, $c^{\hyperlink{ht233}{\mathfrak{z}^{\bean}}} = 0$).
    \end{enumerate}
...
We define $f^{\hyperlink{ht235}{\mathfrak{z}^{\Phi}}}(z^{\hyperlink{ht235}{\mathfrak{z}^{\Phi}}})$ as:
        ...
        \item \textbf{Stalk per BDV:} $\hyperlink{ht235}{\mathfrak{z}^{\Phi}}$ \term{Deposits} receive 1 \term{Stalk} per BDV upon \term{Deposit} (\term{i.e.}, $k^{\hyperlink{ht235}{\mathfrak{z}^{\Phi}}} = 1$).
        \item \textbf{Seeds per BDV:} $\hyperlink{ht235}{\mathfrak{z}^{\Phi}}$ \term{Deposits} receive 0 \term{Seeds} per BDV upon \term{Deposit} (\term{i.e.}, $c^{\hyperlink{ht235}{\mathfrak{z}^{\Phi}}} = 0$).
    \end{enumerate}
\end{document}