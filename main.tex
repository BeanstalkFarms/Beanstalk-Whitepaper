...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{-0.25cm}
        \normalsize{beanstalk.publius@protonmail.com, operations@bean.farm}
        ...
        \vspace{-0.25cm}
        \footnotesize{Modified:} \normalsize{July 31, 2023}
        
        \vspace{-0.25cm}
        \footnotesize{Whitepaper Version:} {\normalsize{2.5.0}}
        
        \vspace{-0.25cm}
        \footnotesize{Code Version:} \href{https://github.com/BeanstalkFarms/Beanstalk}{\normalsize{2.5.0}}\footnote{\href{https://github.com/BeanstalkFarms/Beanstalk}{github.com/BeanstalkFarms/Beanstalk}}
