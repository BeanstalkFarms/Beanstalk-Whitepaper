...
\node [draw=none] at (0.25,0.07) {$\frac{\partial \Delta S}{\partial t}^{\text{lower}}$};
\node [draw=none] at (0.75,0.07) {$\frac{\partial \Delta S}{\partial t}^{\text{upper}}$};
...
\node [draw=none] at (-0.35,0) {\bm{$\frac{\partial \Delta S}{\partial t}$}}; % Chart label
\node [draw=none] at (1.35,0)  {\color{white} $\frac{\partial \Delta S}{\partial t}$}; % Added to center chart
